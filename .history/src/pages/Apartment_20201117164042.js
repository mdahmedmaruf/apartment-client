    ...
    <>
      ...
      <Container>
        <Row className="my-5 py-5">
          <Col md={7}>
            {(apartment.length === 0) ? <Image className='img-fluid w-25' src={loader}/> : <Image className='img-fluid' src={`data:image/jpeg;base64,${apartment[0]?.image.img}`} alt={apartment[0]?.title} />}
          ...
          <Col md={5}>
            <RequestBooking apartmentDetails={apartmentDetails}/>
          </Col>
        </Row>
      </Container>
      <Footer />
