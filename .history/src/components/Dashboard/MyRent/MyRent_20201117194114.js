...
const MyRent = () => {
   ...
   const [loggedInUser, setLoggedInUser] = useContext(UserContext);
     ...
     useEffect(() => {
      fetch(`https://immense-scrubland-81187.herokuapp.com/my-booking-house?email=${loggedInUser.email||loggedInUser.currentEmail}`)
        .then((res) => res.json())
        ...
        <Col md={9}>
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              ...
              myRents.map((myRent) => (
                <MyRentLists myRent={myRent} key={myRent._id} />
              )) 
